            ...
            <div class="form-group"><label class="form-label" for="interest_file">Файл (необязательно)</label><input class="form-input" type="file" id="interest_file" name="interest_file" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx"><div class="form-note">До 3 МБ.</div></div>
                ...
                <div class="form-group" style="margin-top:8px;">
                    <label style="display:flex;align-items:flex-start;gap:8px;font-size:12px;color:#64748b;cursor:pointer;">
                        <input type="checkbox" name="pd_consent" required style="margin-top:2px;flex-shrink:0;">
                        <span>Согласен на <a href="personal_data.php" target="_blank" style="color:#0ea5e9;">обработку персональных данных</a> в соответствии с ФЗ-152</span>
                    </label>
                </div>
            <div class="btn-row">
