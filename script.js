const dict = {
    ru: { n_reg: "РЕЕСТР ТОРГОВ", n_comm: "КОМИССИОННАЯ ПРОДАЖА", b_login: "ВХОД", c1_t: "Участник", c1_p: "Поиск актуальных процедур и подача заявок онлайн.", c2_t: "Регистрация", c2_p: "Получите аккредитацию в системе всего за 24 часа.", c3_t: "Организатор", c3_p: "Размещение лотов и управление торгами.", f_about_p: "ЭТП ЭРА — цифровая экосистема для проведения торгов.", s_home: "Рабочий стол", s_reg: "Реестр торгов", s_fin: "Финансы", welcome: "Добро пожаловать, Артур!" },
    en: { n_reg: "REGISTRY", n_comm: "COMMISSION SALES", b_login: "LOGIN", c1_t: "Bidder", c1_p: "Search lots and submit bids online instantly.", c2_t: "Registration", c2_p: "Get system accreditation in just 24 hours.", c3_t: "Organizer", c3_p: "Post lots and manage your auctions.", f_about_p: "ERA ETP is a digital ecosystem for trading.", s_home: "Dashboard", s_reg: "Registry", s_fin: "Finance", welcome: "Welcome, Arthur!" }
};
